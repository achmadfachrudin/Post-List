...
object DateUtil {
    ...
    const val HHmm = "HH:mm" // 21:00
    const val dd_MMM = "dd MMM" // 21 Jan
    const val dd_MMMM = "dd MMMM" // 21 January
    const val dd_MMMM_yyyy = "dd MMMM yyyy" // 21 January 2021
    const val dd_MM_yyyy = "dd-MM-yyyy" // 21-01-2021
    const val MMMM_yyyy = "MMMM yyyy" // January 2021
    const val MMM_dd_yyyy = "MMM dd, yyyy" // Jan 21, 2021
